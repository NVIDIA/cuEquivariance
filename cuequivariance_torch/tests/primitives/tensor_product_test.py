...
def make_descriptors():
    ...
    yield descriptors.spherical_harmonics(cue.SO3(1), [2]).polynomial.tensor_products[
        0
    ][1]
    yield descriptors.spherical_harmonics(cue.SO3(1), [3]).polynomial.tensor_products[
        0
    ][1]
